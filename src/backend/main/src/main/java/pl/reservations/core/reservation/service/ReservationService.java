...
public class ReservationService {
    ...
    public ReservationDto addReservation(ReservationDto reservationDto, UUID userId) {
        ...
        ReservationMessageDto reservationMessageDto = new ReservationMessageDto();
        reservationMessageDto.setFirstName(user.getFirstname());
        reservationMessageDto.setLastName(user.getLastname());
        reservationMessageDto.setEmail(user.getEmail());
        reservationMessageDto.setDate(reservation.getReservationDate().toString());
        reservationMessageDto.setTime(reservation.getReservationTime());
        reservationMessageDto.setServiceName(employeeOffer.getOffer().getTitle());

        kafkaProducer.sendNewReservation(reservationMessageDto);
    ...
    public void cancelReservation(Long id, UUID userId) {
        ...
        ReservationMessageDto cancellationMessage = new ReservationMessageDto();
        cancellationMessage.setFirstName(user.getFirstname());
        cancellationMessage.setLastName(user.getLastname());
        cancellationMessage.setEmail(user.getEmail());
        cancellationMessage.setDate(reservation.getReservationDate().toString());
        cancellationMessage.setTime(reservation.getReservationTime());
        cancellationMessage.setServiceName(reservation.getEmployeeOffer().getOffer().getTitle());

        kafkaProducer.sendCancelReservation(cancellationMessage);
        reservationRepository.save(reservation);
    }
